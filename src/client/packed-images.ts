...
export const
  ...
  FRUIT = unpack(
    ...
    48,
    16,
    [0xff000000, 0xff0099ff, 0xff0000ff, 0xff00ffff, 0xff0086e0, 0xff0000e0, 0xff00e0e0],
    "",
  ),
  ...
  PIECES = unpack(
    ...
    16,
    [0xff222222],
    "",
  ),
